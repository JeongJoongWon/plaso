...
class CARPEL2TTool(extraction_tool.ExtractionTool):
  NAME = 'carpel2t'
  ...
  def __init__(self, input_reader=None, output_writer=None):
    super(CARPEL2TTool, self).__init__(
  ...
  def ParseArguments(self, arguments):
    ...
    argument_parser.add_argument(
        self._P_NAME, action='store', metavar='PARNAME', nargs='?',
        default=None, type=str, help=(
            'Partition Name'))
  ...
  def ParseOptions(self, options):
    ...
    self.par_name = getattr(options, 'par_name', None)
